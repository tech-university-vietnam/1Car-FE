import { Button, Checkbox, DatePicker, Divider, Form, Input, Modal } from 'antd'
...
export default forwardRef((props, ref) => {
    ...
    return (
        <Modal visible={visible} onCancel={onClose} footer={null} closable={false}>
            <h2 className='text-center text-2xl mb-6'>Welcome to 1Car</h2>
            <Form validateTrigger="onBlur" autoComplete={"off"}>
                <Form.Item name="name" rules={[{ required: true, message: "Please enter your name" }]} >
                    <Input size="large" placeholder='Name' className='p-3 border border-gray-200 rounded w-full' autoComplete={"off"} />
                </Form.Item>
                ...
                <Form.Item name="dateOfBirth" rules={[{ type: "date", message: "Please enter your date of birth" }]} >
                    <DatePicker className='w-full p-3' placeholder='Date of birth' size='large' />
                </Form.Item>
                ...
                <Form.Item>
                    <Checkbox><span className='opacity-50'>I accept with <a>terms and conditions</a>.</span></Checkbox>
                </Form.Item>
                <Form.Item>
